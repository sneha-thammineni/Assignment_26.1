  ...
  render: function () {
    return (
      <form onSubmit={this.handleSubmitEvent}>
        ...
        <div className="form-group">
          <label htmlFor="listItemAvailability">Availability <span style={styleRequired}>*</span></label>
          <div className="row">
            <div className="col-xs-5 col-sm-6 col-md-4">
              <select className="form-control" id="listItemAvailability" required ref="availability" >
